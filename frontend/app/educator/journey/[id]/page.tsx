                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col items-center justify-center backdrop-blur-sm gap-3 p-4">
                          <div className="flex gap-3 w-full justify-center">
                            <Button 
                              ...
                              size="sm"
                            >
                              <Eye className="w-4 h-4 mr-2 text-[#0F172A]" /> <span className="text-[#0F172A]">Preview</span>
                            </Button>
                            ...
                            {!isTeacherResource && (
                              <Button 
                                ...
                                size="sm"
                              >
                                <RefreshCw className="w-4 h-4 mr-2 text-white" /> <span className="text-white">Swap</span>
                              </Button>
                            )}
                          </div>
                          ...
                          {!isTeacherResource && (
                            <Button 
                              ...
                              size="sm"
                            >
                              <Split className="w-4 h-4 mr-2 text-white" /> <span className="text-white">Differentiate</span>
                            </Button>
                          )}
                        </div>
