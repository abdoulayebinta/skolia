    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 hidden sm:flex">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#00b6ff] to-blue-600 flex items-center justify-center shadow-md shadow-blue-200">
                <BrainCircuit className="w-5 h-5 text-white" />
              </div>
              <span className="font-bold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#00b6ff] to-blue-600">
                IDÉLLIA
              </span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00b6ff] to-blue-600 text-white flex items-center justify-center text-sm font-bold shadow-md">
              JD
            </div>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-white shadow-lg shadow-blue-100 mb-6 border border-blue-50">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#00b6ff] to-blue-600 flex items-center justify-center text-white">
              <Sparkles className="w-6 h-6" />
            </div>
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4 tracking-tight">
            Design Your Next <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00b6ff] to-blue-600">Learning Journey</span>
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden animate-fade-in-up delay-100">
          <div className="p-1 bg-gradient-to-r from-[#00b6ff] via-blue-400 to-blue-500 opacity-50"></div>
          ...
          <div className="p-6 sm:p-8">
            <div className="relative mb-6">
              <textarea
                ...
                className="w-full h-48 p-5 text-lg text-slate-700 placeholder:text-slate-400 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#00b6ff] focus:ring-4 focus:ring-[#00b6ff]/10 outline-none resize-none transition-all duration-200 ease-in-out"
                maxLength={500}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <Button 
                ...
                size="lg"
                className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-[#00b6ff] to-blue-600 hover:from-[#00a0e0] hover:to-blue-700 text-white shadow-lg shadow-[#00b6ff]/25 border-0 rounded-xl font-semibold transition-all transform hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {suggestions.map((s, i) => (
              <button
                key={i}
                onClick={() => setPrompt(s)}
                className="group flex items-center p-4 bg-white rounded-xl border border-slate-200 hover:border-[#00b6ff]/50 hover:shadow-md hover:shadow-blue-100 transition-all duration-200 text-left"
              >
